		...
		<table class="table">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td><?= $row['status']; ?></td>
		      <td>
		      	<a href="<?= site_url('pengaduan/edit/'.$row['id_pengaduan']); ?>" class="btn btn-warning btn-sm">Edit</a>
		      	<a href="<?= site_url('pengaduan/hapus/'.$row['id_pengaduan']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin?')">Delete</a>
		      </td>
		    </tr>
		<?php } ?>
		  </tbody>
