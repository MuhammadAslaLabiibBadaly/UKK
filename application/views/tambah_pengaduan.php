...
<body>
	...
	<div class="container">
		...
		<form method="post" action="<?= site_url('pengaduan/simpan'); ?>">
		  <div class="mb-3">
		  ...
		  <div class="mb-3">
		  	...
		  	<textarea class="form-control" name="isi_laporan" id="isi_laporan" rows="4"></textarea>
		  </div>
		  <div class="mb-3">
		  ...
		  <div class="mb-3">
		    ...
		    <select class="form-select" id="status" name="status">
		    	<option value="read" class="readonly"></option>
